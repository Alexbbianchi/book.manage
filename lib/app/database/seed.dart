...
const insertBook = '''
INSERT INTO books (title, author, publishing_company, isbn, format, publication_date, pages, language, serie, volume, description, image, start_date, end_date, status, pages_read, item_type, notes)
...
INSERT INTO book_to_genres(book_id, genre_id) VALUES (1, 2);
''';
const insertBookToGenre2 = '''
INSERT INTO book_to_genres(book_id, genre_id) VALUES (1, 5);
''';

const insertBookToGenre3 = '''
INSERT INTO book_to_genres(book_id, genre_id) VALUES (1, 6);
''';

const insertBook1 = '''
INSERT INTO books (title, author, publishing_company, isbn, format, publication_date, pages, language, serie, volume, description, image, start_date, end_date, status, pages_read, item_type)
...
const insertShelf = '''
INSERT INTO shelfs (name)
VALUES ('Teste');
''';

const insertShelfToBook = '''
INSERT INTO shelf_to_books (shelf_id, book_id)
VALUES (1, 1);
''';
...
INSERT INTO borroweds (book_id, name, borrowed_date)
